...
def download_raw_burstsr_data(download_path):
    ...
    train_burst_list = train_burst_list[:100]
    print(train_burst_list)
    for burst_id in train_burst_list:
        if not os.path.isfile('{}/{}.zip'.format(train_out_dir, burst_id)):
            ...
            print('{}{} has already been downloaded'.format(train_out_dir, burst_id))
...
def main():
    ...
    path = 'C:/Users/Default.DESKTOP-FRPMN5G/Documents/Master/UC'
    download_raw_burstsr_data(path)
